...
const NAV_STRUCTURE = [
  ...
  { path: '/ash-hq', icon: Brain, label: 'Ash Command Center', access: ['owner', 'manager'] },
  { path: '/ash-plans', icon: Trophy, label: 'Ash Plans', access: ['owner', 'manager'] },
  { path: '/ash-permissions', icon: ShieldCheck, label: 'Ash Permissions', access: ['owner'] },
  { path: '/ash-memory', icon: FileText, label: 'Ash Memory', access: ['owner', 'manager'] },
